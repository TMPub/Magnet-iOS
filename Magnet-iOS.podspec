Pod::Spec.new do |s|
  ...
  s.source              = { :http => 'https://github.com/TMPub/Magnet-iOS/archive/refs/tags/2.0.0.zip' }
  s.vendored_frameworks = 'Magnet-iOS-2.0.0/Framework/Magnet.xcframework'
  s.resource_bundles      = {
    'Magnet' => ['Magnet-iOS-2.0.0/Assets/*.png']
  }
